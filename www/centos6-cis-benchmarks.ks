...
logvol / --vgname vg_root --name root --fstype=ext4 --size=4096
# CIS 1.1.1-1.1.4
logvol /tmp --vgname vg_root --name tmp --size=512 --fsoptions="nodev,nosuid,noexec"
# CIS 1.1.5
logvol /var --vgname vg_root --name var --size=512
# CIS 1.1.7
logvol /var/log --vgname vg_root --name log --size=512
# CIS 1.1.8
logvol /var/log/audit --vgname vg_root --name audit --size=512
# CIS 1.1.9-1.1.0
logvol /home --vgname vg_root --name home --size=512 --grow --fsoptions="nodev"
